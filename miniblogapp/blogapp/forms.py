...
class SignupForm(UserCreationForm):   
    ...
    #first_name = forms.CharField(label='First Name1' )

    #last_name =  forms.CharField(label='Last Name2' )
    ...
    class Meta:
        ...
        labels = {'username' : 'Enter Username','first_name' : 'Enter First Name','last_name' : 'Enter lastname', 'email' : 'Email'}       
